        ...
        <div>
            ...
            <div className ='dataWindow'>
                ...
                <font color='black' size='6'>
                    ...
                    <Link to="/Registration"><br/><br/><strong className ='button_reg' id='reg_button' onClick={() => {
                        // changeContainerPlanet(containerPlanet = null)
                    }}>REGISTRATION</strong><br/></Link>

                    <Link to="/Login"><strong className ='button_log' id='log_button' onClick={() => {
                        // changeContainerPlanet(containerPlanet = null)
                    }}>LOGIN</strong></Link>
